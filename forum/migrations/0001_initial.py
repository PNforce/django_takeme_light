# Generated by Django 2.1 on 2020-07-16 10:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('task_id', models.CharField(blank=True, max_length=7)),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', models.DateTimeField(default=django.utils.timezone.now)),
                ('task_id', models.CharField(blank=True, max_length=7)),
                ('user', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='UserHistorys', to='forum.Registration')),
            ],
        ),
        migrations.AddField(
            model_name='comment',
